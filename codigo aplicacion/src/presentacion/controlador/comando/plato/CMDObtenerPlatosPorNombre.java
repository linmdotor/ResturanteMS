...
public class CMDObtenerPlatosPorNombre implements CMD {
	...
	public RespuestaCMD ejecuta(Object objeto) {
		...
		try {
			respuestaComando = new RespuestaCMD(EnumComandos.OBTENERPLATOS, serviciosProductosCarta.obtenerPlatosPorNombre());
		} catch (Exception e) {
