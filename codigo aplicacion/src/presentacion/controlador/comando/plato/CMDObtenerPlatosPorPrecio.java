...
public class CMDObtenerPlatosPorPrecio implements CMD {
	...
	public RespuestaCMD ejecuta(Object objeto) {
		...
		try {
			respuestaComando = new RespuestaCMD(EnumComandos.OBTENERPLATOS, serviciosProductosCarta.obtenerPlatosPorPrecio());
		} catch (Exception e) {
