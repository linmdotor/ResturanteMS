...
public class PlatoPorPrecio implements Query {
	...
	public Object execute(Object objeto) 
	{
        ...
        try {
            ...
            ResultSet rs = c.createStatement().executeQuery("select p.*, c.Tipo from Plato p, Plato_Comida c where p.ID_Plato = c.ID_Plato_Comida" + " FOR UPDATE");
            ...
            rs = c.createStatement().executeQuery("select p.*, b.Alcoholica from Plato p, Plato_Bebida b where p.ID_Plato = b.ID_Plato_Bebida" + " FOR UPDATE");
